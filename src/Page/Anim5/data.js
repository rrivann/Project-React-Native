export default [
  {
    type: 'Humlan P',
    imageUri: require('../../Assets/Anim5/urbanears_blue.png'),
  ...
  {
    type: 'Pampas',
    imageUri: require('../../Assets/Anim5/urbanears_pink.png'),
  ...
  {
    type: 'Humlan P',
    imageUri: require('../../Assets/Anim5/urbanears_grey.png'),
  ...
  {
    type: 'Humlan B',
    imageUri: require('../../Assets/Anim5/urbanears_mint.png'),
    heading: 'From Sweden',
    description:
